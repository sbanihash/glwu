...
!     and from the file multiwavespnc.inp ( NDSI, output requests ).
...
!
      J = LEN_TRIM(FNMPRE)
      OPEN (NDSI,FILE=FNMPRE(:J)//'multiwavespnc.inp',STATUS='OLD',        &
            ERR=800,IOSTAT=IERR)
...
! 4.2 Selects first time FILETIME between out_pnt.ww3 and multiwavespnc.inp
...
!
      ...
      ELSE
        ...
        END IF
!
! Short version of the multiwavespnc code for ITYPE = 1
!                                    and OTYPE = 3
!
