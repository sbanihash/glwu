...
!
      J      = LEN_TRIM(FNMPRE)
      OPEN (NDSI,FILE=FNMPRE(:J)//'multiwavegrads_points.inp',STATUS='OLD',         &
            ERR=800,IOSTAT=IERR)
...
!
 1000 FORMAT (/' *** WAVEWATCH III ERROR IN WAVEGXSP : '/               &
               '     ERROR IN OPENING INPUT FILE'/                    &
               '     IOSTAT =',I5/)
!
 1001 FORMAT (/' *** WAVEWATCH III ERROR IN WAVEGXSP : '/               &
               '     PREMATURE END OF INPUT FILE'/)
!
 1002 FORMAT (/' *** WAVEWATCH III ERROR IN WAVEGXSP : '/               &
