...
!/
      ...
      CHARACTER(LEN=512), PARAMETER  :: SWITCHES  = &
                    'F90 NCO NOPA LRB4 NCEP2 SHRD SCRIP SCRIPNC NC4 PR3 UQ ST4 STAB0 FLX0 LN1 NL3 BT1 DB1 IC0 IS0 REF0 ML' // &
                    'IM TR0 BS0 XX0 WNX1 WNT1 CRX1 CRT1 O0 O1 O2 O4 O5 O6 O7 O14 O15' // &
                    ''
!/
      CONTAINS
!/ ------------------------------------------------------------------- /
