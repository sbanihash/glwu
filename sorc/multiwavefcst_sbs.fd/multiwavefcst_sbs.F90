...
!     identical to multiwavefcst_sbs.ftn, and reads the corresponding input
!     file multiwavefcst_sbs.inp
!
...
!
!     CALL WMINIT ( 8, 9, 6, 6, 6, 'multiwavefcst_sbs.inp', MPI_COMM )
!
! ... Screen output disabled
!
!     CALL WMINIT ( 8, 9, 9, 6, 6, 'multiwavefcst_sbs.inp', MPI_COMM )
!
! ... Separate test output file and file preamble defined
!
!     CALL WMINIT ( 8, 9, 6, 10, 6, 'multiwavefcst_sbs.inp', MPI_COMM,        &
!                   './data/' )
!
