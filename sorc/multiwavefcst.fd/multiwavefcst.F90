...
!
!     CALL WMINIT ( 8, 9, 6, 6, 6, 'multiwavefcst.inp', MPI_COMM )
!
! ... Screen output disabled
!
!     CALL WMINIT ( 8, 9, 9, 6, 6, 'multiwavefcst.inp', MPI_COMM )
!
! ... Separate test output file and file preamble defined
!
!     CALL WMINIT ( 8, 9, 6, 10, 6, 'multiwavefcst.inp', MPI_COMM,        &
!                   './data/' )
!
! ... Separate test output file
!
      INQUIRE(FILE="multiwavefcst.nml", EXIST=FLGNML)
      IF (FLGNML) THEN
        CALL WMINITNML ( 8, 9, 6, 10, 6, 'multiwavefcst.nml', MPI_COMM )
      ELSE
        CALL WMINIT ( 8, 9, 6, 10, 6, 'multiwavefcst.inp', MPI_COMM )
      END IF
!
